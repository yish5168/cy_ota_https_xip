...
# Flash and RAM size for app run by CM0+
APP_CM0P_FLASH_SIZE=0x25800
APP_CM0P_RAM_SIZE=0x19000

# Flash size for app run by CM4
APP_CM4_FLASH_SIZE=0x1AE800
...
MCUBOOT_PRIMARY_1_SLOT_SIZE=0x1D8000 #$(APP_CM4_FLASH_SIZE)+$(APP_CM0P_FLASH_SIZE)
MCUBOOT_PRIMARY_2_SLOT_SIZE=0x100000
# Note: the external flash sector size is 256K 
MCUBOOT_SECONDARY_1_SLOT_SIZE=0x1D8000 #$(APP_CM4_FLASH_SIZE)+$(APP_CM0P_FLASH_SIZE)
MCUBOOT_SECONDARY_2_SLOT_SIZE=0x100000
...
# This value can be simply set to MCUBOOT_PRIMARY_1_SLOT_SIZE/FLASH_ROW_SIZE.
# For PSoC 6, FLASH_ROW_SIZE=512 bytes. 768 2048 2304
MCUBOOT_MAX_IMG_SECTORS=3776 #1952
# For S25FL512, FLASH_SECTOR_SIZE=256Kbytes, MCUBOOT_PRIMARY_2_SLOT_SIZE/FLASH_SECTOR_SIZE. 0xEC
MCUBOOT_EXT_MAX_IMG_SECTORS=0x3B
